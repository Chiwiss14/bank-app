                        ...
                        <div class="row">
                            ...
                            <div class="col text-center">
                                <span class="payments-status text-warning"><i class="fas fa-ellipsis-h"
                                        data-toggle="tooltip" data-original-title="In Progress"></i></span>
                            </div>
                            <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col text-center">
                                <span class="payments-status text-success"><i data-toggle="tooltip"
                                        data-original-title="Completed" class="fas fa-check-circle"></i></span>
                            </div>
                            <div class="col">
                                <span class="payment-amaount">- $0.2</span>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col text-center">
                                <span class="payments-status text-danger"><i data-toggle="tooltip"
                                        data-original-title="Cancelled" class="fas fa-times-circle"></i></span>
                            </div>
                            <div class="col">
                                <span class="payment-amaount">- $0.2</span>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col text-center">
                                <span class="payments-status text-warning"><i data-toggle="tooltip"
                                        data-original-title="Completed" class="fas fa-exclamation-circle"></i></span>
                            </div>
                            <div class="col">
                                <span class="payment-amaount">- $0.2</span>
                            </div>
                ...
                <div class="items">
                    <a href="transactions-details.html">
                        <div class="row">
                            ...
                            <div class="col text-center">
                                <span class="payments-status"><i class="fas fa-ellipsis-h" data-toggle="tooltip"
